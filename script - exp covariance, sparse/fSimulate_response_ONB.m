function [response, transfer_true, specCrossdensity_true] = fSimulate_response_ONB(onb,response_process,pars_response_process,dataFullONB_padded,dataFull_padding,specDensity_true)
% inputs
%   onb ... struct for ONB
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%        calculate the response process Y
...
for t = 1:nGridTime
    ...
    for lag = 1:(transfer_true.numOfLags*2+1)
        ...
        response(t) = response(t) + dataFullONB_padded(t+dataFull_padding-lag_real,:) * transfer_true.ONB(lag,:)' ;
    end    
...
% model noise
response = response + transfer_true.sigma*randn(size(response));
