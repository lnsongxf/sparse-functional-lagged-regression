...
fileName_truncation = 'exp_sim_threshold_value.csv';
fileName_complete_Tikhonov = 'exp_sim_complete_tikhonov.csv';
fileName_complete_truncation = 'exp_sim_complete_threshold.csv';
...
disp("FAR(1) exponential kernel")
squeeze(table_sim(1,:,:))
disp("FMA(4) exponential kernel")
squeeze(table_sim(2,:,:))
