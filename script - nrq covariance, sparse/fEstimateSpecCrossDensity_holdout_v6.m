function specCrossDensity = fEstimateSpecCrossDensity_holdout_v6(censor,onb,response,response_mean,mu_est_inSpace,bw_F,nGridFreq,holdout)
...
% specCrossDensity.q_bartlett = floor( 2* censor.nGridTime^(1/3)); % v5
specCrossDensity.q_bartlett = floor( censor.nGridTime^(1/3)); % v6
