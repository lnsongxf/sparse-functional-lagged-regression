function specDensity = fEstimateSpecDensity_v6(censor,onb,mu_est_inSpace,bw_F,nGridFreq)
...
% specDensity.q_bartlett = floor( 2* censor.nGridTime^(1/3)); % v5
specDensity.q_bartlett = floor( censor.nGridTime^(1/3)); % v6
    ...
    for tau_ii = 1:onb.nGridSmoother
        ...
        for tau_jj = 1:onb.nGridSmoother                            
            ...
            for pq = 1:3
                ...
                save_Q(nu_i,pq,tau_ii,tau_jj) = sum(1/censor.nGridTime .* ...
                    Y{lag+1} .* ...
                    kern1 .* ...
                    kern2 .* ...
            ...
            for pq = 1:6
                ...
                save_S(nu_i,pq,tau_ii,tau_jj) = sum(1/censor.nGridTime .* ...
                    kern1 .* ...
                    kern2 .* ...
                    ((dev1)/bw_F).^p  .* ((dev2)/bw_F).^q);
            end
...
for ii = 1:specDensity.nGridFreq
    specDensity.norms(ii) = norm( squeeze(specDensity.smoother(ii,:,:)) );
end
