function [censor, dataFull, dataFullONB, dataFull_padded, dataFullONB_padded, covs_true, mu_true, specDensity_true, MA_order, sigma] = fSimulate_MA(onb,simulated_process,nGridTime,nRandi_max,nRandi_min,nGridFreq,dataFull_padding)
...
par_covE = onb.onbMatrix' * par_covE_inSpace * onb.onbMatrix / onb.nGridSpace^2;

% MA coeficients
par_A1_inSpace = sin((g'+g));
par_A2_inSpace = sin(((1-g)'+g));
par_A3_inSpace = sin(((1-g)'+(1-g)));
par_A4_inSpace = sin((g'+(1-g)));
