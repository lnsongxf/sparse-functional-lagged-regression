...
% data_truncation = dataFull_truncation(dataFull_truncation.simulated_process == 1, :);
% data_Tikhonov = dataFull_Tikhonov(dataFull_Tikhonov.simulated_process == 1, :);
...
%         
%         
%         multipliers = unique(subdata_truncation.transfer_Threshold_multiplier);
...
%             rho = multipliers(k);
%             vec.transfer_RMSE(k) = median( subdata_truncation.transfer_RMSE( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%             vec.ZErrorTrain(k) = median( subdata_truncation.ZErrorTrain( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%             vec.ZErrorTrain_true(k) = median( subdata_truncation.ZErrorTrain_trueDynamics_( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%             vec.ZErrorTest(k) = median( subdata_truncation.ZErrorTest( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%             vec.ZErrorTest_true(k) = median( subdata_truncation.ZErrorTest_trueDynamics_( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%             vec.vec.ZErrorTrain_holdout_(k) = median( subdata_truncation.ZErrorTrain_holdout_( subdata_truncation.transfer_Threshold_multiplier == rho ) );
%         end
%         
