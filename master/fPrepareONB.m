function onb = fPrepareONB(nGridSpace, nKnots)
...
onb.gridSpace2Smoother_indx = 1:10:onb.nGridSpace; % XXX here it should match !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
onb.gridSmoother = onb.gridSpace(onb.gridSpace2Smoother_indx);
...
for ii = 1:onb.nGridSmoother
    onb.H_smoother2space(ii, onb.gridSpace2Smoother_indx(ii)) = 1;
end
